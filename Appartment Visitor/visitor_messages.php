...
$txtwhom=$_POST['txtwhom'];
		...
		mysqli_query($con,"insert into visitormessage set 						
						VisitorName			=	'$txtname',
						Mobile	=	'$txtmobile',						
						Address			=	'$txtaddress',
						toWhomVisit			=	'$txtwhom',
	...
	header("location: visitor_messages.php");
		...
		<div class="row">
			...
			<div class="col-md-10">
				<div class="panel panel-primary">
					<div class="panel-heading text-center">Visitor Messages	</div>
					<div class="panel-body"> 
						...
						<div class="row">
							...
							<div class="col-md-6">
								...
								<input type="text" class="form-control" id="txtwhom" name="txtwhom">
							</div>							
						</div>						
						<div class="row">
							...
							<div class="col-md-12">
								...
								<input type="text" class="form-control" id="txtdetails" name="txtdetails" >
							</div>
						</div>						
						<p></br></p>
						<div class="row">
