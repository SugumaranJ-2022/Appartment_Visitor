    ...
    <nav class="navbar navbar-inverse" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">Appartment Visitor Tracking System</a>
...
<div class="row">
				...
				<div class="col-md-8">
					<div class="table-responsive" align="center">
						<table class="table table-bordered" style="width:250px;color:#fff;" align"center">
														
							<form class="col-md-12" action="#" method="post">
							<tr><td colspan="2"><h4 align="center">Login Area</h4></td></tr>
					 		<tr><td>UserName</td>
